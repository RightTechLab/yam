...
pub struct App {
    ...
    pub tor_bitcoin_rpc_onion: String,
...
impl App {
    pub fn new(config: &crate::infra::config::YamConfig) -> Self {
        Self {
            ...
            tor_bitcoin_rpc_onion: "Determining...".into(),
            electrs_onion: "Determining...".into(),
            mempool_onion: "Determining...".into(),
            explorer_onion: "Determining...".into(),
